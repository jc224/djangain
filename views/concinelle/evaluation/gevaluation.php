...
<div class="content container-fluid">
    ...
    <div class="content-page">
        ...
        <form class="md-float-material form-material"
            ...
            action="<?= yii::$app->request->baseurl . '/' . md5('evaluation_organiser') ?>"
                ...
                <div class="card-body">
                    ...
                    <div class="row filter-row">
                        ...
                        <div class="col-sm-2 col-md-3">
                            ...
                            <a href="javascript:;" onclick="rechercher()"

                                class="btn btn-search btn-sm rounded btn-block mb-3"> Rehercher
                                            ...
                                            foreach ($classe as $key => $vaal) {
                                                ...
                                                if(sizeof($matiere)>0){
                                                    ...
                                                    foreach ($matiere as $key => $value2) {
                                                        ...
                                                        $liste = Yii::$app->evaluationClass->selectEvalforclassefrmatiere($anneeActive, $vaal['code'],$value2['code']);
                                                        ...
                                                        if (sizeof($liste) > 0) {
                                                            ...
                                                            foreach ($liste as $key => $value) {
                                                                ...
                                                                $detail = '<a href="' . yii::$app->request->baseUrl . '/' . md5('evaluation_concinelledetails') . '/' . $value['codeEva'] . '" class="btn btn-outline-primary mr-2"><i class="fa fa-eye" aria-hidden="true"></i> Details</a>';
                        ...
                        <div class="modal-body box-shadow">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="classe" id="classeSelect"

                                        onchange="selectmatiere()">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <input type="text" class="form-control" placehoder="coeficient"

                                            name="Coeficient" id="Coeficient" readonly="readonly">
