<div class="content container-fluid">
    ...
    <div class="content-page">
        ...
        <form class="md-float-material form-material"
            ...
            action="<?= yii::$app->request->baseurl . '/' . md5('evaluation_organiserconcinelle') ?>" enctype="multipart/form-data"
                ...
                <div class="card-body">
                    ...
                    <div class="row filter-row">
                        ...
                        <div class="col-sm-2 col-md-3">
                            ...
                            <a href="javascript:;" onclick="rechercher()" class="btn btn-search btn-sm rounded btn-block mb-3"> Rehercher

                            </a>

                        </div>

                        <div class="col-sm-3  text-right add-btn-col">

                            <input type="file" id="fileInput" name="fichier" accept=".xlsx" style="display:none;">



                            <a href="#" class="btn btn-primary float-right btn-rounded" onclick="selectFile()"><i
                        ...
                        <div class="col-sm-3 text-right add-btn-col">
                            ...
                            <a href="#" class="btn btn-primary float-right btn-rounded" data-toggle="modal"

                                data-target="#delete_employee"><i class="fas fa-plus"></i> Ajouter une Evaluation</a>
                                    ...
                                    <tbody>
                                        ...
                                        if (sizeof($liste) > 0) {
                                            ...
                                            foreach ($liste as $key => $value) {
                                                ...
                                                $sup = '<button class="btn  btn-outline-danger mr-2" id="btnexport" onclick="document.getElementById(\'action\').value=\'' . md5(strtolower("supprimer")) . '\';document.getElementById(\'code\').value=\'' . $value['codeClasse'] . '\';

                                                document.getElementById(\'codeEva\').value=\'' . $value['codeEva'] . '\';document.getElementById(\'eval-form\').submit;"><span class="ml-2">supprimer</span></button>';
                                                ...
                                                $detail = '<a href="' . yii::$app->request->baseUrl . '/' . md5('evaluation_concinelledetails') . '/' . $value['codeEva'] . '" class="btn btn-outline-primary mr-2"><i class="fa fa-eye" aria-hidden="true"></i></a>';
                                                ...
                                                echo '<tr>
                                                    ...
                                                    <td class="text-right">' . $detail . ' ' . $note . ' '.$sup.' </td>
