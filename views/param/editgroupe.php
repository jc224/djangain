<div class="content container-fluid">
  ...
  <div class="page-content">
    <form class="needs-validation" novalidate=""
      action="<?= Yii::$app->request->baseUrl . '/' . md5('param_adduser') ?>" name="login-form" id="anneescolaire-form"
      method="post">
      <input type="hidden" name="_csrf" value="<?= Yii::$app->request->getCsrfToken() ?>" />
      <input type="hidden" name="action" id="action" value="<?= md5('updatety') ?>" />
      <input type="hidden" name="code" id="code" value="<?= $code ?>" />
      <div class="row">
        <div class="col-sm-12 col-md-12 mt-2 " style="margin-bottom:20px ;">
          <div class="page-title">MODIFIER UN GROUPE D'UTILISATEURS </div>
            ...
            <div class="card-body">
              ...
              <div class="row mb-12">
                ...
                <div class="col-md-12 mt-10 mb-15">
                  <input type="text" name="libelle"  value="<?=$libelle['groupe']?>" class="form-control">
                </div>
              </div>
              ...
              <div class="row " style="margin-top:20px;margin-bottom:20px">
                ...
                $menuperse = explode(Yii::$app->params['sousMenu'], yii::$app->menuactionClass->Mainaction($code));
                // die(var_dump($menuperse));
                    ...
                    for ($i = 1; $i < sizeof($subMenuArray); $i++) {
                      if (!(in_array($subMenuArray[$i], $ajaxAction))) {
                        ...
                        echo '   <div class="col-md-1 pb-2">
                                <input  class = "form-control form-checkbox site" type="checkbox" name="menuaction[]" value="' . $subMenuArray[$i] . '"   ' . $checked . '> 
                  ...
                  foreach ($menuArray as $value) {
                    ...
                    for ($i = 1; $i < sizeof($subMenuArray); $i++) {
                      if (!(in_array($subMenuArray[$i], $ajaxAction))) {
                        ...
                        echo '   <div class="col-md-1 pb-2">
                                <input  class = "form-control form-checkbox " type="checkbox" name="menuaction[]" value="' . $subMenuArray[$i] . '" ' . $checked . '> 
              ...
              <div class="row " style="margin-top:20px;margin-bottom:20px">
                <div class="col-12">
                  <p>EVALUATION</p>
                  <input class="form-control form-checkbox " hidden checked type="checkbox" name="menuaction[]"
                    value="@evaluationconcinelle">

                </div>
                <?php
                $menuString = yii::$app->params['evaluationconcinelle'];
                // die($menuString);
