                ...
                <div class="card">
                  <div class="card-header">
                    <div class="row align-items-center">
                      <div class="col-sm-6">
                        <div class="page-title">Liste des Actes Pour Le Personnel </div>
                      </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form class="needs-validation" novalidate=""
                      action="<?= Yii::$app->request->baseUrl . '/' . md5('param_payementpers') ?>" name="login-form"
                    ...
                    <div class="modal-footer">
                      <a href="javascript:;" onclick="ajouterpaiementpers()" class="btn   btn-primary" id="btnajout">Enregistrer</a>
