<div class="content container-fluid">
    ...
    <div class="page-content">
        <form class="md-float-material form-material" action="<?= Yii::$app->request->baseUrl . '/' . md5('communication_canalcommunication') ?>" name="login-form" id="formsubmit" method="post">
                        ...
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6 text-sm-right d-flex justify-content-end">
                                    <select name="groupe" id="groupe" class="form-control form-select w-50" onchange="selectgroue()">
                                        <option value="" hidden>Veuillez selectionner un groupe</option>
                                        <option value="1">Parents</option>
                                        <option value="2">Professeurs</option>
                                        <?php
                                        if (sizeof($users) > 0) {
