<div class="content container-fluid">
  ...
  <form class="md-float-material form-material"
    action="<?= Yii::$app->request->baseUrl . '/' . md5('parents_emploie') ?>" name="login-form"
    ...
    <div class="row staff-grid-row">
      ...
      if (sizeof($listeparents) > 0) {
        foreach ($listeparents as $key => $value) {
          ...
          //  die(var_dump($infoeleves));
          if (sizeof($infoeleves) > 0) {
            echo '
                        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            <div class="profile-img">
                                <a href="javascript:;" onclick="  document.getElementById(\'action\').value=\'' . md5(strtolower("profil")) . '\';  document.getElementById(\'code\').value=\'' . $value["codeeleve"] . '\';$(\'#anneescolaire-form\').submit(); "><img class="avatar" src="' . yii::$app->request->baseUrl . '/web/mainAssets/uploads/' . $infoeleves['0']['photo'] . '" alt=""></a>
                            </div>
                            ...
                            <a href="javascript:;" class="btn btn-secondary mt-3" onclick="  document.getElementById(\'action\').value=\'' . md5(strtolower("profil")) . '\';  document.getElementById(\'code\').value=\'' . $value["codeeleve"] . '\';$(\'#anneescolaire-form\').submit(); ">
                           Voir L\'emploie du temps</a>
