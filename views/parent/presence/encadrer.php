                    ...
                    if (sizeof($infoeleves) > 0) {
                       ...
                       <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="javascript:;" onclick="presence()">' . $infoeleves['0']['nom'] . ' ' . $infoeleves['0']['prenom'] . '</a></h4>
                            <a href="javascript:;" class="btn btn-primary mt-3" onclick="presence(\''. $infoeleves['0']["matricule"] .'\')">
                              Présence</a>
...
<script>
    function presence(codeeleve){
        ...
        $.post(
			...
			{ codeeleve:codeeleve, action_key: 'presence', _csrf: '<?= Yii::$app->request->getCsrfToken() ?>' },
			function (response) {
