...
<table style="margin-top:20px; border:0px solid black   ;">
    <tr style=" border:0px solid black ">
        ...
        <td colspan="4" style=" border:0px solid black; padding-left:25%;padding-right:25%;text-align:center ">
            ...
            <p style="font-size:16px;text-align: center; font-weight:bold;padding-top:20px;">FICHE DE NOTE DE LA <?= strtoupper($classe) ?></p>
...
<div class="row">
    ...
    <div class="col">
        <div class="row">
            <div class="col lefth">
                <p><span>PERIODE : <?= $periode ?></span></p>
                <p><span>MATIERE : <?= $matiere ?></span></p>

            </div>

            <div class="col leftg">
                <p><span>ANNEE SCOLAIRE : <?= $annee ?></span></p>
        ...
        <table class="table table-bordered text-center " style="height:80%;margin-top:10px">
            <thead class="text-white" style="background-color:rgb(155, 187, 89)">
                ...
                <tr>
                    ...
                    <td style="font-size:15px;">Orale</td>
                    <td style="font-size:15px;">Ecrite</td>
                    <td style="font-size:15px;">Moyenne 1</td>
                    <td style="font-size:15px;">Orale</td>
                    <td style="font-size:15px;">Ecrite</td>
                    <td style="font-size:15px;">Moyenne 2</td>
                    <?php if ($codePeriode > 3) {

                        echo '
                                <td style="font-size:15px;" >Orale</td>
                            <td style="font-size:15px;">Ecrite</td>
                            <td style="font-size:15px;">Moyenne 3</td>
                        ';
                    }
                    ?>
