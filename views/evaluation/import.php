                                        ...
                                        if(sizeof($donner)>0){
                                            ...
                                            foreach ($donner as $key => $value) {
                                                 $info= Yii::$app->mainCLass->databycode('dj_eleve',$value['matricule'],'matricule')['0'];
                                                      ...
                                                      <td><input type="number" class="form-control form-control-solid" min="0" max="'.$max.'" name="notea1[]" value="'.$value['notea1'].'" id="notea1'.$j.'" onchange="calcmoy1('.$j.');" ></td>
                                                      <td><input type="number" class="form-control form-control-solid" min="0" max="'.$max.'" name="notea2[]" value="'.$value['notea2'].'"  id="notea2'.$j.'" onchange="calcmoy1('.$j.');" ></td>
                                                      <td><input type="number" class="form-control form-control-solid" min="0" max="'.$max.'" name="moy1[]" value="'.$value['notea'].'" id="notea'.$j.'"  readonly ></td>
                                                      <td><input type="number" class="form-control form-control-solid" min="0" max="'.$max.'" name="noteb1[]" value="'.$value['noteb1'].'" id="noteb1'.$j.'" onchange="calcmoy2('.$j.');" ></td>
                                                      <td><input type="number" class="form-control form-control-solid" min="0" max="'.$max.'" name="noteb2[]" value="'.$value['noteb2'].'"  id="noteb2'.$j.'" onchange="calcmoy2('.$j.');" ></td>
                                                      <td><input type="number" class="form-control form-control-solid" min="0" max="'.$max.'" name="moy2[]" value="'.$value['noteb'].'" id="noteb'.$j.'"  readonly ></td>
                                                       ';

                                                       if($infoeval['typeEval'] == 2){
                                                            echo '
                                                            <td><input type="number" class="form-control form-control-solid" min="0" max="'.$max.'" name="notec1[]" value="'.$value['noteb1'].'" id="notec1'.$j.'" onchange="calcmoy3('.$j.');" ></td>
                                                            <td><input type="number" class="form-control form-control-solid" min="0" max="'.$max.'" name="notec2[]" value="'.$value['noteb2'].'"  id="notec2'.$j.'" onchange="calcmoy3('.$j.');" ></td>
                                                            <td><input type="number" class="form-control form-control-solid" min="0" max="'.$max.'" name="moy3[]" value="'.$value['noteb'].'" id="notec'.$j.'"  readonly ></td>
