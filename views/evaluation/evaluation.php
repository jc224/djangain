<div class="content container-fluid">
    ...
    <div class="content-page">
        ...
        <form class="md-float-material form-material"
            ...
            action="<?= yii::$app->request->baseurl . '/' . md5('evaluation_organiser') ?>" enctype="multipart/form-data"
                                    ...
                                    <tbody>
                                        ...
                                        if (sizeof($liste) > 0) {
                                            ...
                                            foreach ($liste as $key => $value) {
                                                ...
                                                $detail = '<a href="' . yii::$app->request->baseUrl . '/' . md5('evaluation_details') . '/' . $value['codeEva'] . '" class="btn btn-outline-primary mr-2"><i class="fa fa-eye" aria-hidden="true"></i></a>';
                                                ...
                                                echo '<tr>
                                                    ...
                                                    <td class="text-right">' . $detail . ' ' . $note . ' </td>
