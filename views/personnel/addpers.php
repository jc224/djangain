                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <form class="" enctype="multipart/form-data" method="post"  id="formsubmit" novalidate="novalidate"

                                action="<?= Yii::$app->request->baseUrl . '/' . md5("personnel_addpersonnel") ?>">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btnsubmit').click(function() {
            ...
            let requiredFields = ['#prenom','#fontion','#Datedebutservice','#lnai','#dnais','#genre','#email','#nom','#tel'];
