                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <h5 class="text-uppercase mb-0 mt-0 page-title">profil personnel</h5>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            <ul class="breadcrumb float-right p-0 mb-0">
                                <li class="breadcrumb-item"><a href="index.html"><i class="fas fa-home"></i> Home</a></li>
                                <li class="breadcrumb-item"><a href="all-teachers.html">personnel</a></li>
                                <li class="breadcrumb-item"><span> profil personnel</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                            ...
                                                            <div class="aboutprofile-name">
                                                                ...
                                                                <p class="text-center"><?php
                                                                                    $fonction = yii::$app->mainCLass->databycode('dj_fonction',$info['fonction'],'code');
                                                                                echo $fonction['0']['libelle'];
                                                                ?></p>
                                                            </div>
