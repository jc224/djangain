...
<table style="margin-top:20px; border:0px solid black   ;">
    <tr style="border:0px solid black ">
        <td style="border:0px solid black ">
            <img src="<?= yii::$app->basePath ?>/web/mainAssets/uploads/<?=$infoets['logo'] ?>" alt="" style=" width: 140px;">
        </td>
        <td colspan="4" style=" border:0px solid black; padding-left:20%;padding-right:20%;text-align:center ">
            ...
            <p style="font-size:16px;text-align: center; font-weight:bold;padding-top:20px;">LISTE DES PERSONNELS </p>
...
<div class="row">
    ...
    <?php 
     if(isset($post['catsearch']) && !empty($post['catsearch'])){
        $info= Yii::$app->mainCLass->databycode('dj_fonction',$post['catsearch'],'code')['0'];
         echo '    <p><span>Fonction : '.$info['libelle'].'</span></p>
         ';
     }
    ...
    <p><span>ANNEE SCOLAIRE : <?= $annee['0']['libelle'] ?></span></p>
            ...
            <thead class="text-white"  style="background-color:rgb(155, 187, 89)">
                       ...
                       <tr style="font-size:13px;">
                                                        ...
                                                        <th style="min-width:50px;font-size:13px;">Fonction</th>
