...
<div class="content container-fluid">
    ...
    <div class="page-content">
        ...
        <form id="sumit" method="post" action="<?= Yii::$app->request->baseUrl . '/' . md5('evaluation_resultat') ?>">
                                                    ...
                                                    if (sizeof($liste) > 0) {
                                                        ...
                                                        foreach ($liste as $key => $info) {
                                                            if (sizeof($matiere) > 0) {
                                                                ...
                                                                foreach ($matiere as $key => $value):
                                                                    ...
                                                                    if ($moy1 == false) {
                                                                        ...
                                                                        if ($classe['typeCompo'] == '1') {
                                                                            ...
                                                                            $moyenne1 = yii::$app->simplelClass->moyenneMoyennegenral($cours, $moy1['composition']);
                                                                ...
                                                                $result = yii::$app->simplelClass->moySemestre($dataTrim1, $classe['typeCompo']);
                                                                ...
                                                                $content .= '
                                                                          <td>' . $result['Totalcours'] . '</td>
                                                                          <td>' . $result['MoyenneCours'] . '</td>
                                                                          <td>' . $result['totalCompo'] . '</td>
