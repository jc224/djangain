                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <form class="" enctype="multipart/form-data" method="post" novalidate="novalidate"
                                    ...
                                    <input type="hidden" name="_csrf"
                                        vlue="<?= Yii::$app->request->getCsrfToken() ?>" />
                                    <input type="hidden" name="code" id="code" value="<?= $info['code'] ?>" />

                                    <div class="form-group">
                                        <label>Nom</label>
                                        <input type="text" name="nom" id="nom" value="<?= $info['nom'] ?>"
                                            class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="genre" id="genre" aria-hidden="true">
                                            <option value="1" <?= $info['genre'] == 1 ? 'selected' : '' ?>>Masculin
                                            </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?= $info['dateNais'] ?>" id="dnais"
                                            name="dnais" type="date">
                                    </div>
                                    <div class="form-group">
                                        <label> Adresse</label>
                                        <input class="form-control " type="text" id="lnai"
                                            value="<?= $info['adresse'] ?>" name="adresse">
                                    </div>
                                    <div class="form-group">
                                        <label> Date début Service</label>
                                        <input class="form-control " id="Datedebutservice"
                                            value="<?= $info['Datedebutservice'] ?>" name="Datedebutservice"
                                            type="date">
                                    </div>
                                    <div class="form-group students-up-files">

                                        <label class="" for="form1Example1" style=" font-style: oblique;">Photo
                                            :</label>
                                        ...
                                        <div class="image-input image-input-outline  image-input-empty "
                                            ...
                                            <div id="image-cropper-result" class="image-input-wrapper w-125px  h-125px;"
                                                ...
                                                <img style="width:125px; height:125px;"
                                                    src="<?= yii::$app->request->baseUrl . yii::$app->params['linkToUploadIndividusProfil'] . $info['photo'] ?>">
                                            </div>
                                            ...
                                            <label
                                                ...
                                                <input type="text" hidden id="" name="avatare"
                                                    value="<?= $info['photo'] ?>" />
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <div class="form-group">
                                    <label>Prénoms</label>
                                    <input type="text" name="prenom" id="prenom" value="<?= $info['prenom'] ?>"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Numéro de téléphone </label>
                                    <input class="form-control" name="tel" id="tel" value="<?= $info['tel'] ?>"
                                        type="text">
                                </div>

                                <div class="form-group">
                                    <label> Matricule</label>
                                    <input type="text" name="mat" id="mat" value="<?= $info['matricule'] ?>"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label>Lieu de Naissance</label>
                                    <input type="text" name="lieuNai" id="lieuNai" value="<?= $info['lieuNais'] ?>"
                                        class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="groupe" id="groupe" aria-hidden="true">
                                        ...
                                        <option value="1" <?= $info['groupePers'] == 1 ? 'selected' : '' ?>>Titulaire
                                        </option>
                                        <option value="2" <?= $info['groupePers'] == 2 ? 'selected' : '' ?>>Non Titulaire
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>A propos</label>
                                    <textarea class="form-control" value="<?= $info['apropos'] ?>" id="desc" name="desc"
                                        rows="4"></textarea>
                                </div>
