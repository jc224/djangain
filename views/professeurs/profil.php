                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                            ...
                                                            <?php  
                                                               ...
                                                               $listecours =  Yii::$app->personnelClass->listmatiereformprof($info['code'],$anneeactive);
                                                        
                                                                if(sizeof($listecours)>0){
                                                                    foreach ($listecours as $key => $value) {
                                                                      
                                                                        $matiere =  Yii::$app->personnelClass->listematiereonmatiereclasse($value['code_classmat']);
                                                                        // die(var_dump($matiere));
                                                                        echo '<li class="list-group-item"><b>'.$matiere['matiere'].'</b><a href="#" class="float-right">'.$matiere['classe'].'</a></li>';
                                                                    }
                                                                }
                                                            ?>
