                  ...
                  <div class="card-header">
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="page-title">LISTE DES MOTIFS DE DEPENSE </div>
                      ...
                      <div class="col-sm-6 text-sm-right">
                        ...
                        <a href="#" class="btn btn-primary text-reight" onclick="$('#etat').css('display','none'); $('#anneescolaire-form')[0].reset()" data-toggle="modal"
                          ...
                          data-target="#add_leavetype">Ajouter une Categorie </a>
                        ...
                        <div class="table-responsive">
                          ...
                          <table class="datatable table table-stripped dataTable no-footer" id="DataTables_Table_0"
                            ...
                            <thead>
                              ...
                              <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                  ...
                                  style="width: 191.016px;">Cat Depense</th>
                            ...
                            <tbody>
                              ...
                              if (isset($depense) && sizeof($depense)) {
                                ...
                                foreach ($depense as $key => $value) {
                                  ...
                                  $btnmodifier = '<button type="button" class="btn btn-primary modifierAnee"   onclick="$(\'#etat\').css(\'display\',\'block\');document.getElementById(\'action\').value=\'' . md5(strtolower("modifierdepense")) . '\';document.getElementById(\'libelle\').value=\'' . $value['libelle'] . '\'; document.getElementById(\'code\').value=\'' . $value['code'] . '\'; " style="background-color:#041e42;" 
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-head bg-primary">
                      ...
                      <h4 class="modal-title" id="standard-modalLabel">Categorie Depense</h4>
                    ...
                    <div class="modal-body">
                      <form class="md-float-material form-material"
                        ...
                        action="<?= Yii::$app->request->baseUrl . '/' . md5('comptable_catdepense') ?>" name="login-form"
                    ...
                    <div class="modal-footer">
                      ...
                      <button  onclick="ajoutcat()" class="btn   btn-primary" id="btnajout">Enregistrer</a>
